  ...
  return (
    <div className="mx-auto max-w-6xl px-5 py-12 sm:px-8 lg:py-16">
      ...
      <div className="mt-10 grid gap-6 lg:grid-cols-[340px_1fr] lg:gap-8">
        ...
        <div className="flex flex-col gap-6">
          ...
          <section className="glass-panel rounded-xl p-6">
            ...
            <div className="mt-5 border-t border-white/8 pt-5">
              ...
              <p className="mb-3 text-xs text-slate-400">Request a reset link to your email.</p>
              <Link
        ...
        {/* ── RIGHT COLUMN: avatar picker + achievements ── */}
        <div className="flex flex-col gap-6">

          {/* Avatar picker */}
          <section className="glass-panel rounded-xl p-6">
            <h2 className="mb-5 text-base font-semibold text-white">Avatar</h2>
            <AvatarPicker
              userId={user.id}
              current={avatarType}
          ...
          {/* Achievements */}
          <section className="glass-panel rounded-xl p-6">
            <h2 className="mb-5 text-base font-semibold text-white">Achievements</h2>
            <AchievementList
