    ...
    >
      ...
      <div className="mt-16 grid gap-12 lg:grid-cols-2 lg:gap-20">
        <div className="flex flex-col gap-6">
          ...
          <p className="text-base leading-8 text-slate-300">{m.mission1p1}</p>
          <p className="text-base leading-8 text-slate-300">{m.mission1p2}</p>
        </div>
        ...
        <div className="flex flex-col gap-6">
          ...
          <p className="text-base leading-8 text-slate-300">{m.mission2p1}</p>
          <p className="text-base leading-8 text-slate-300">{m.mission2p2}</p>
        </div>
      </div>
    </section>
  );
