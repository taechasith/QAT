      ...
      <header className="relative mx-auto w-full max-w-7xl px-5 pb-10 pt-16 sm:px-8 lg:px-10">
        <div className="grid gap-6 lg:grid-cols-[minmax(0,1fr)_minmax(18rem,24rem)] lg:items-end lg:gap-12">
          <div className="min-w-0">
            ...
            <h1 className="mt-3 max-w-5xl text-4xl font-semibold tracking-tight text-white sm:text-5xl lg:text-[3.25rem]">
              {title}
            </h1>
          </div>
          <p className="max-w-prose text-sm leading-7 text-muted-foreground lg:justify-self-end">
            {description}
          </p>
        </div>
