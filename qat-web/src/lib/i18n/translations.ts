  ...
  en: {
    ...
    admin: {
      ...
      form: {
        ...
        cover: "Cover (16:9 — image, GIF or video)",
        ...
        onlyImages: "Only image or video files are accepted.",
        maxSize: "File must be under 50 MB.",
  ...
  th: {
    ...
    admin: {
      ...
      form: {
        ...
        cover: "รูปภาพหน้าปก (อัตราส่วน 16:9 — ภาพนิ่ง GIF หรือวิดีโอ)",
        ...
        onlyImages: "รองรับเฉพาะไฟล์รูปภาพหรือวิดีโอเท่านั้น",
        maxSize: "ขนาดไฟล์ต้องมีขนาดน้อยกว่า 50 MB",
