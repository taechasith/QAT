...
export const t = {
  ...
  th: {
    ...
    admin: {
      title: "ระบบจัดการหลังบ้าน (Admin CMS)",
      nav: {
        dashboard: "แผงควบคุม",
      ...
      form: {
        ...
        categoryGuides: {
          ...
          exhibition: {
            label: "นิทรรศการเด่น (Exhibition)",
          ...
          research_article: {
            label: "บทความและงานวิจัย (Research / Article)",
          ...
          news: {
            label: "ข่าวสารและประชาสัมพันธ์ (News)",
          ...
          talk: {
            label: "งานเสวนาเชิงวิชาการ (Talk)",
          ...
          experiment: {
            label: "ผลงานการทดลองสร้างสรรค์ (Experiment)",
